...
class TestDumpDataclass:
    ...
    def test_basic_dump(self) -> None:
        ...
        assert result == {'name': 'John', 'age': 30, 'email': 'john@example.com', 'active': True}
...
class TestIterDataclassDict:
    ...
    def test_basic_iteration(self):
        ...
        expected = [('name', 'Test'), ('age', 20), ('email', 'test@test.com'), ('active', True)]
...
class TestJsonDumpsDataclass:
    ...
    def test_basic_json_dump(self):
        ...
        assert parsed == {'name': 'JSON Test', 'age': 30, 'email': 'json@test.com', 'active': True}
...
class TestIterDataclass:
    ...
    def test_basic_field_iteration(self):
        ...
        assert len(items) == 4
        assert items == [('name', 'Iter Test'), ('age', 45), ('email', None), ('active', True)]
